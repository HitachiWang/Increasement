...
ncdisp('D:/data/Ensemble/ERA40_U850.nc');
...
OBS=ncread('d:/data/Ensemble/ERA40_U850.nc','u',[1 1 7],[144 73 129]);
lat=ncread('d:/data/Ensemble/ERA40_U850.nc','latitude');
lon=ncread('d:/data/Ensemble/ERA40_U850.nc','longitude');
   %参考时间平均
ref=2;
